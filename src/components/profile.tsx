  ...
  return (
    <section className="max-w-2xl mx-auto">
      <div className="relative flex gap-6">
        {/* Decorative elements */}
        <div className="absolute -left-4 top-0 w-px h-16 bg-gradient-to-b from-gray-200 to-transparent" />
        ...
        <div className="space-y-3">
          ...
          <div>
            <h1 className="font-mono text-2xl tracking-tight">
              ...
              <span className="ml-3 font-sans text-sm text-gray-400 tracking-wider uppercase">
          ...
          {/* Contact info */}
          <div className="flex items-start gap-x-6 text-xs text-gray-500">
            ...
            <div className="flex flex-wrap items-center gap-3">
              {socialLinks.map((link) => (
                <a
                  key={link.label}
                  href={link.href}
                  className={`group flex items-center transition-all duration-200 ${link.color}`}
                  target="_blank"
