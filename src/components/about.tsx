    ...
    <div className="font-serif max-w-3xl">
      ...
      <div className="space-y-5">
        ...
        <div className="space-y-6">
          ...
          <div>
            <h2 className="text-base font-medium text-gray-900 mb-3 tracking-wide">Current Software Work</h2>
          ...
          {/* Leadership Section */}
          <div>
            <h2 className="text-base font-medium text-gray-900 mb-3 tracking-wide">Present Leadership</h2>
            <div className="space-y-1.5 text-sm text-gray-600 leading-relaxed">
              <div className="flex items-start gap-2">
                <span className="text-gray-400 font-mono text-xs mt-0.5">{'>'}</span>
          ...
          {/* Hackathons Section */}
          <div>
            <h2 className="text-base font-medium text-gray-900 mb-3 tracking-wide">Some Hackathons I've Done</h2>
            <div className="space-y-1.5 text-sm text-gray-600 leading-relaxed">
              <div className="flex items-start gap-2">
                <span className="text-gray-400 font-mono text-xs mt-0.5">{'>'}</span>
        ...
        <div>
        <h2 className="text-base font-medium text-gray-900 mb-3 tracking-wide">Triathlon Training</h2>
        <div className="space-y-1.5 text-sm text-gray-600 leading-relaxed">
            <div className="flex items-start gap-2">
            <span className="text-gray-400 font-mono text-xs mt-0.5">{'>'}</span>
